...
const Main = () => {
  return (
    <div className="p-5 w-full h-screen bg-gradient-to-b from-[#F6C234] via-yellow-500 to-[#275336]">
        ...
        <h2 className='text-4xl text-blue-900 text-center font-bold my-16 antialiased'>Agende agora a troca de óleo e mantenha seu carro em perfeitas condições. Deixe-nos cuidar disso para você!</h2>
